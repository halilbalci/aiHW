            ...
            if(0 in possibleSolution):
                ...
                for cons in self.constraintBase: #complete solution check constraints 
                    ...
                    if(isValidAssignment): # solution found
                        print("subject1=>",possibleSolution[0],possibleSolution[4],possibleSolution[8],possibleSolution[12])
                        print("subject2=>",possibleSolution[1],possibleSolution[5],possibleSolution[9],possibleSolution[13])
                        print("subject3=>",possibleSolution[2],possibleSolution[6],possibleSolution[10],possibleSolution[14])
                        print("subject4=>",possibleSolution[3],possibleSolution[7],possibleSolution[11],possibleSolution[15])
...
class App:
    def main(self):
        x=self.inputInteger("Choose a puzzle 1 or 2 or 3 (0 to quit):")
        while(x==None):
            x=self.inputInteger("Choose a puzzle 1 or 2 or 3(0 to quit):")
        if(x!=0):
            try:
